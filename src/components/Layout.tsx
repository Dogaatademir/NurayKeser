...
const navLinks = [
  { name: "Ana Sayfa", href: "#/" },
  { name: "Portföyler", href: "#/portfoyler" },
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
    ...
    <div className="min-h-screen flex flex-col font-sans bg-[#FAFAFA] text-[#0A1628]">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          {/* Logo - Boyut h-18 olarak güncellendi */}
          ...
          {/* Desktop Navigation - Yazılar büyütüldü ve kalınlaştırıldı */}
          <nav className="hidden lg:flex items-center gap-10">
            {navLinks.map((link) => (
              <a 
                key={link.name} 
                href={link.href} 
                className="group relative text-[16px] font-medium tracking-[0.01em] text-[#4A5568] hover:text-[#112769] transition-colors duration-300"
              >
                <span>{link.name}</span>
          ...
          {/* Mobile Menu Button - İkon boyutu logo ile dengeli olması için hafif büyütüldü */}
          <button 
      ...
      >
        ...
        >
          ...
          {/* Navigation Links - Mobil için de biraz büyütüldü */}
      ...
      {/* MAIN CONTENT - Dinamik header yüksekliğine uyum sağlaması için margin artırıldı */}
      <main className="flex-1 pt-[110px]">
        {children}
      </main>

      {/* FOOTER - Gradyan kalktı, düz ve asil lacivert (#112769) geldi */}
            ...
            <div className="lg:col-span-5">
              <div className="flex flex-col gap-6">
                <div className="flex flex-col">
                  {/* Footer Logosu (Dilersen buraya da logo.png koyabilirsin) */}
                ...
                <div className="flex gap-4 mt-2">
                  {[
                    ...
                    >
                      <svg className="w-4 h-4 text-white/70 group-hover:text-[#C5A572] transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
                        <path d={social.icon} />
                      </svg>
                    </a>
                  ))}
  ...
  >
    <address className="not-italic text-[15px] font-light text-white/90 leading-relaxed tracking-wide group-hover:text-[#C5A572] transition-colors duration-300">
      Yukarı Bahçelievler Mah.<br/>
      Kazakistan Cad. (4. Cad.) No:101/A<br/>
      Çankaya / Ankara
    </address>
  </a>
</div>
          ...
          <div className="py-6 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-2 text-[13px] text-white/50">
              ...
              <a 
                href="#" 
                className="text-[#C5A572] hover:text-white transition-colors duration-300 font-medium"
              >
                Doğa Ata Demir
              </a>
            </div>
